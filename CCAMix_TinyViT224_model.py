...
class TinyViT(nn.Module):
    def __init__(self, img_size=224, in_chans=3, num_classes=1000,
        ...
        self.conv5 = conv(64, 32, kernel_size=1, stride=1, padding=0, output_padding=0, transposed=True)
        self.bn5 = nn.BatchNorm2d(32)
        self.conv6 = conv(32, 32, stride=2, transposed=True)
        self.bn6 = nn.BatchNorm2d(32)
        self.conv7 = conv(32, 32, stride=2, transposed=True)
    ...
    def forward(self, x, local=False, superpixel_map=None, topN_local_ratio=None):
        ...
        if local:
            ...
            # print(x_up1.shape)  #torch.Size([16, 32, 56, 56])
            x_up2 = self.relu(self.bn6(self.conv6(x_up1)))
            # print(x_up2.shape)  #torch.Size([16, 32, 112, 112])
            x_up3 = self.bn7(self.conv7(x_up2))
            # print(x_up3.shape)  #torch.Size([16, 32, 224, 224])

            SPAttention_batch, topN_SurPFeat_batch, topN_SurPFeat_idx_batch = self.SAP(x_up3, superpixel_map, topN_local_ratio)  # list(32*[n, 256])
            ...
            return logits, topN_SurPLocalCls_batch, topN_SurPFeat_idx_batch, SPAttention_batch,  x_up3
        else:
            return logits
