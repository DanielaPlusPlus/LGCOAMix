...
from networks.A0913_DeiT_CCAMix_LessChannel import DeiTB_CCAMix
...
def make_print_to_file(path='./'):
    ...
    sys.stdout = Logger(fileName + 'CUB_224_DeiTB_CCAMix_LessChannel.log', path=path)
...
parser = argparse.ArgumentParser(description="CUB_224_DeiTB_CCAMix")
...
parser.add_argument("--N_max",  type=float, default=38)
...
net_name = './Models_out/CUB_224_CE_DeiTB_LGCOAMix_best_LessChannel.pt'
if len(args.gpu_ids) > 1:
    if args.RESUME:
        net = DeiTB_CCAMix(pretrained=True, NUM_CLASS=args.NUM_CLASS)
        net.head = nn.Linear(768, args.NUM_CLASS)
...
results_file_name = results_out_dir +  tm + 'CUB_224_DeiTB_CCAMix_LessChannel_results.txt'
...
#     elif 9 < epoch <= 89:  # 59
#         lr = args.LR
#     elif 90 < epoch <= 104: # 40
#         lr = args.LR / 2
#     elif 105 < epoch <= 119: # 50
#         lr = args.LR / 4
#     elif 120 < epoch <= 134: # 40
#         lr = args.LR / 8
#     elif 135 < epoch <= 149:  # 50
#         lr = args.LR / 10
#     elif 150 < epoch <= 164:  # 40
#         lr = args.LR / 20
#     elif 165 < epoch <= 179:  # 40
#         lr = args.LR / 40
#     elif 180 < epoch <= 194:  # 30
#         lr = args.LR / 80
#     elif 195 < epoch <= 204:  # 50
#         lr = args.LR / 100
#     elif 205 < epoch <= 214:  # 30
#         lr = args.LR / 200
#     elif 215 < epoch <= 219:  # 30
#         lr = args.LR / 400
#     elif 220 < epoch <= 224:  # 30
#         lr = args.LR / 800
#     elif 225 < epoch <= 229:  # 20
#         lr = args.LR / 1000
#     else:
#         lr = args.LR / 5000  # 20
#     print("current lr:", lr)
